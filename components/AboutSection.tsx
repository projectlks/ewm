...
export function AboutSection(): React.JSX.Element {
  // 💡 Custom Hook မှ Function (၂) ခုကို လှမ်းခေါ်လိုက်ရုံပါပဲ
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 md:gap-6">
          ...
          <div
            ...
            className="col-span-1 lg:col-span-2 bg-[#F8F9FA] rounded-[1.5rem] p-8 md:p-10 border border-gray-100 flex flex-col justify-between relative transition-all duration-300  hover:border-gray-200">
            <div>
              <div className="inline-flex items-center px-3 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-xs font-semibold uppercase tracking-wider mb-5">
                About Us
              </div>
          ...
          {/* =====================
              Vision Box (မူလ အပြာရောင်နောက်ခံ ပြန်လည်အသုံးပြုထားပါသည်)
              ===================== */}
          <div
            onMouseEnter={(e) => handleMouseEnter(e)}
            onMouseLeave={handleMouseLeave}
            className="col-span-1 bg-blue-50/60 rounded-[1.5rem] p-8 md:p-10 border border-blue-100 flex flex-col relative transition-all duration-300  hover:border-blue-200">
            <span className="text-blue-600 text-[10px] font-bold tracking-widest uppercase mb-6 opacity-80">
              01 / Vision
            </span>
            <div>
          ...
          {/* =====================
              Mission Box (မူလ မီးခိုးရောင်နောက်ခံ ပြန်လည်အသုံးပြုထားပါသည်)
              ===================== */}
          <div
            onMouseEnter={(e) => handleMouseEnter(e)}
            onMouseLeave={handleMouseLeave}
            className="col-span-1 bg-[#F8F9FA] rounded-[1.5rem] p-8 md:p-10 border border-gray-100 flex flex-col relative transition-all duration-300  hover:border-gray-200">
            <span className="text-gray-400 text-[10px] font-bold tracking-widest uppercase mb-6">
              02 / Mission
            </span>
            <div>
          ...
          {/* =====================
              Accent Box (မူလ အမည်းရောင်နောက်ခံ ပြန်လည်အသုံးပြုထားပါသည်)
              ===================== */}
          <div
            onMouseEnter={(e) => handleMouseEnter(e)} // 💡 အမည်းရောင်ဖြစ်၍ Border ကို အဖြူရောင်ဖျော့ပြောင်းရန် true ဟု ထည့်ထားပါသည်
            onMouseLeave={handleMouseLeave}
            className="col-span-1 bg-gray-900 rounded-[1.5rem] p-8 md:p-10 border border-gray-800 flex items-center justify-center text-center relative overflow-hidden transition-all duration-300  ">
            <div className="absolute inset-0 bg-[radial-gradient(#ffffff33_1px,transparent_1px)] [background-size:14px_14px] opacity-20 transition-opacity duration-500 hover:opacity-30"></div>
            <p className="relative z-10 text-white text-base md:text-lg font-medium leading-relaxed">
              &quot; Reliable, highly{" "}
              <span className="text-blue-400">interoperable systems</span>{" "}
              tailored to your needs.&quot;
