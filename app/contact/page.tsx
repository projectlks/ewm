...
import ContactForm from "@/components/ContactForm"; // လမ်းကြောင်းမှန်ကန်အောင် ပြင်ပေးပါ

// 💡 "use client" လုံးဝ မပါတော့ဘဲ 100% React Server Component အဖြစ် အလုပ်လုပ်ပါမည်
export default function ContactPage(): React.JSX.Element {
  return (
    <main className="min-h-screen bg-white py-32 px-4 sm:px-6 md:px-12">
      <div className="mx-auto px-4 md:px-6">
        ...
        {/* 💡 Client Component ဖြစ်သော Form ကို ဤနေရာတွင် ခေါ်သုံးထားပါသည် */}
        <ContactForm />
      </div>
    </main>
  );
